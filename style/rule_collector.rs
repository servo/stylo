    ...
    E: TElement,
{
    ...
    pub fn new(
        ...
        // Gecko and Servo has pseudo-elements with style attributes,
        // like ::-moz-color-swatch and ::-servo-input-color-swatch.
        debug_assert!(
            cfg!(feature = "gecko") || cfg!(feature = "servo") || style_attribute.is_none() || pseudo_element.is_none(),
